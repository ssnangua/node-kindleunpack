...
def main(argv=unicode_argv()):
    ...
    print("   Based on initial mobipocket version Copyright (c) 2009 Charles M. Hannum <root@ihack.net>")
    print("   Extensive Extensions and Improvements Copyright (c) 2009-2020 ")
